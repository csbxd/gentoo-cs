...
QA_PREBUILT="
	...
	usr/libexec/${MY_PN}/${MY_PN}-resources/voice/bin/codex-voice-host
	usr/libexec/${MY_PN}/${MY_PN}-resources/voice/lib/*
...
src_install() {
	...
	fperms 0755 \
		...
		"${install_dir}/${MY_PN}-resources/voice/bin/codex-voice-host" \
